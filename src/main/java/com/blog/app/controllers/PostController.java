...
public class PostController {
	...
	public ResponseEntity<List<PostDto>> getPostsByCategory(@PathVariable Integer categroyId){
		List<PostDto> posts = this.postService.getPostsByCategory(categroyId);
		return new ResponseEntity<List<PostDto>>(posts, HttpStatus.OK);
	}
